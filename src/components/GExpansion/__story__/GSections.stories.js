...
export const Demo = () => ({
  ...
  <div style="width: 300px; height: 600px; padding-top: 10px; border: 1px solid #E0E0E0; overflow: auto">
      ...
      <g-sections v-model="activeItem" item-header="title" :key="100" :multiple="multiple">
        <g-sections-item :item="singleItem">
        ...
        <g-sections-item v-for="(item, index) in items" :item="item" :key="index">
          {{item.content}}
        </g-sections-item>
      </g-sections>
  </div>
