...
export default {
  name: 'GStepper',
  components: { GStepperStep, GStepperHeader },
  props: {
    altLabels: Boolean,
    nonLinear: Boolean,
    steps: Array,
  ...
  setup(props, context) {
    ...
    const { toggleItem, isActiveItem } = groupable(Object.assign({}, {items: props.steps}, { mandatory: true, multiple: false }), model);
