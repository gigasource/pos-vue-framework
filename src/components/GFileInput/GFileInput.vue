  ...
  setup(props, context) {
    ...
    function genAppendInner() {
      return <div class="g-tf-append__inner">
        {(context.slots['append-inner']) ? context.slots['append-inner']({onClearIconClick}) : <>
    ...
    const hintClasses = computed(() => (props.persistent || (isFocused.value && isValidInput.value))
      ? {'g-tf-hint__active': true} : {})
