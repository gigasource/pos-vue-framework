		...
		<g-card flat elevation="24">
			...
			<g-card-text>
				<div>
					...
					find a way to escape. I'm a thing. But, like most politicians, he promised more than he could deliver. You won't have time for sleeping, soldier, not with all the bed
					making you'll be doing. Then we'll go with that data file! Hey, you add a one and two zeros to that or we walk! You're going to do his laundry? I've got to
					find a way to escape.
				</div>
			</g-card-text>
			<g-card-actions>
				<g-button width="100px" color="#1271ff" text-color="#ffddcc" class="waves-effect">DON'T CLICK!</g-button>
				<g-button>CLICK ME!</g-button>
			</g-card-actions>
		</g-card>
...
<script>
  ...
  export default {
    name: 'CardDemo',
    components: { GRadio, GRadioGroup, GButton, GCardActions, GCardText, GCardTitle, GCard },
    data() {
      return {}
    }
  }
