...
<!--          <template #activator="{on}">-->
<!--            <button v-on="on">open-on-hover</button>-->
<!--          </template>-->
<!--          <span>...</span>-->
<!--        </g-tool-tip>-->
<!--      </div>-->
...
<!--      <div>-->
<!--        <h4>Delay</h4>-->
<!--        <g-tool-tip open-on-hover open-delay="500">-->
<!--          <template #activator="{on}">-->
...
<!--        <br>-->
<!--        <g-tool-tip open-on-hover close-delay="500">-->
<!--          <template #activator="{on}">-->
...
<!--      <div>-->
<!--        <h4>3.2) Nudge</h4>-->
<!--        <g-tool-tip open-on-hover nudge-right="300">-->
<!--          <template #activator="{on}">-->
<!--            <button v-on="on">Nudge right 300</button>-->
<!--          </template>-->
<!--          <span>...</span>-->
<!--        </g-tool-tip>-->

<!--        <g-tool-tip open-on-hover nudge-bottom="300">-->
<!--          <template #activator="{on}">-->
<!--            <button v-on="on">Nudge bottom 300</button>-->
<!--          </template>-->
<!--          <span>...</span>-->
<!--        </g-tool-tip>-->
<!--      </div>-->
...
<!--      <div>-->
<!--        <h4>3.3) Absolute position</h4>-->
<!--        <g-tool-tip open-on-hover absolute absoluteX=100>-->
<!--          <template #activator="{on}">-->
<!--            <button v-on="on">Absolute X = 100, Y undefined</button>-->
<!--          </template>-->
<!--          <span>X=100, Y=undefined</span>-->
<!--        </g-tool-tip>-->

<!--        <g-tool-tip open-on-hover absolute absoluteY=100>-->
<!--          <template #activator="{on}">-->
<!--            <button v-on="on">Absolute X = undefined, Y = 100</button>-->
<!--          </template>-->
<!--          <span>X=undefined, Y=100</span>-->
<!--        </g-tool-tip>-->

<!--        <g-tool-tip open-on-hover absolute absoluteX=100 absoluteY=100>-->
<!--          <template #activator="{on}">-->
<!--            <button v-on="on">Absolute X = 100, Y = 100</button>-->
<!--          </template>-->
...
<!--        </template>-->
<!--        <span>Tooltip color #ff4444</span>-->
<!--      </g-tool-tip>-->
<!--    </div>-->
  </div>
</template>
