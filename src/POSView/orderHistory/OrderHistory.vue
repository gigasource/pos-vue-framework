    ...
    <div area="order" class="order" style=" padding: 14px 9px 14px 9px">
      ...
      <div style="padding: 6px 8px 8px 8px; border-top: 1px solid #D4D4D4">
        <div style="display: flex">
          <p style="font-weight: bold; font-size: 12px; line-height: 15px; margin: 16px 13px 4px 0">Promotional Applied </p>
          <g-spacer/>
          <p style="font-weight: normal; font-size: 12px; line-height: 15px; margin: 16px 0 4px 0">- € 50</p>
        </div>
        <div style="display: flex">
          <p style="font-weight: bold; font-size: 12px; line-height: 15px;color: #FF4452; margin: 4px 13px 4px 0">Discount 10% </p>
          <g-spacer/>
          <p style="font-weight: normal; font-size: 12px; line-height: 15px;color: #FF4452; margin: 4px 0px 4px 0">- € 50</p>
        </div>
        <g-divider/>
        <div style="display: flex">
